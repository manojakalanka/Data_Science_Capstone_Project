...
shinyUI(   fluidPage(
  ...
  mainPanel(
    ...
    wellPanel(
      h4("Details"),
      HTML("<p> Github Repository <a href='https://github.com/manojakalanka/Data_Science_Capstone_Project' target='_blank'>https://github.com/manojakalanka/Data_Science_Capstone_Project</a></p>"),
      HTML("<p> Slide Deck Presentation  <a href='http://rpubs.com/manojakalanka/636054' target='_blank'>http://rpubs.com/manojakalanka/636054</a></p>"),
      h4("Author:"),
      p("Enrique Estrada")
    )
